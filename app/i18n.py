...
ES_TO_EN: dict[str, str] = {
    ...
    "2 · Firmá de forma segura": "2 · Sign securely",
    "Continuar con Nostr": "Continue with Nostr",
    "Usar otra app Nostr o QR": "Use another Nostr app or QR",
    "Usar extensión del navegador": "Use browser extension",
    "En mobile podés abrir una app Nostr; en desktop también podés escanear un QR.": "On mobile, open a Nostr app; on desktop, you can also scan a QR code.",
