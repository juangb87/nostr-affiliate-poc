(() => {
  ...
  const messages = {
    es: {
      ...
      declined: ['Cashback declinado', 'El comercio declinó esta recompensa. Si considerás que fue un error, contactá al comercio con los datos de tu compra.'],
      expired: ['Seguimiento expirado', 'La ventana de atribución terminó sin una compra confirmada.'],
      icons: {tracking: '✓', confirmed: '✓', pending: '₿', paid: '✓', declined: '–', expired: '–'},
    ...
    en: {
      ...
      declined: ['Cashback declined', 'The merchant declined this reward. If you believe this is an error, contact the merchant with your purchase details.'],
